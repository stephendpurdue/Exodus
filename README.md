...
Exodus is a procedurally generated dungeon crawler created in Unity. Each run generates a unique dungeon layout using Binary Space Partitioning (BSP) for room placement, and random-walk algorithms for corridor generation. The game is available to play on itch.io.
...
- Built as a standalone Unity project with a clear structure to ensure easy updating or extension by other developers.
